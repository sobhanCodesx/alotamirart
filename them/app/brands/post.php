...
<head>
    ...
    <meta name="description" content="<?php echo isset($post['des']) ? strip_tags($post['des']) : ''; ?>">
    ...
    <meta property="og:description" content="<?php echo (isset($err) && $err == true) ? (isset($post['des']) ? strip_tags($post['des']) : '') : 'پست مورد نظر پیدا نشد'; ?>">
    ...
    <meta name="twitter:description" content="<?php echo (isset($err) && $err == true) ? (isset($post['des']) ? strip_tags($post['des']) : '') : 'پست مورد نظر پیدا نشد'; ?>">
        ...
        <div class="col-12 col-md-7">
            <?php if (isset($err) && $err == true) { ?>
                <div class="box-content-cities p-3">
                    ...
                    <!-- ===== باکس تماس برجسته (چلو دست) ===== -->
                    <?php
                    $displayPhoneNumber = !empty($post['contact_number']) ? $post['contact_number'] : (isset($user['phon']) ? $user['phon'] : '');
                    ?>
                    <div class="contact-box">
                        ...
                        <a href="tel:<?php echo $displayPhoneNumber; ?>" class="phone-number">
                            <i class="fas fa-phone-alt"></i>
                            <?php echo $displayPhoneNumber; ?>
                        </a>
                    ...
                    <?php if (isset($_SESSION['name']) && isset($_SESSION['role']) && $_SESSION['role'] == 1) { ?>
                        <div style="text-align: center; margin: 10px 0 15px;">
                            <button class="btn-success">
                                <a class="nav-link" target="_blank" href="<?php echo assets('admin/brands/post/update/'. (isset($post['id']) ? $post['id'] : '') ); ?>">

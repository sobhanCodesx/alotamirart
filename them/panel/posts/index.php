                    ...
                    <tbody>
                        ...
                        foreach ($post as $c) { ?>
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="<?= $c['status'] == 0 ? assets('user/post/update/'.$c['id']) : assets('post/'.$c['id']) ?>"><?=$c['status'] == 0 ? 'آپدیت' : 'مشاهده مقاله'  ?></a><br>
                ...
                <div class="container mt-5 mb-3">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    <?php echo get_pag($page, trim('user/post/',"/ "), $pages, ''); ?>
                                    <li class="page-item">
